...
function principal() {
  const media = [
    { src: 'assets/images/8_de_junio.webp', alt: 'imagen-1', clickable: false, type: 'image', component: <Image src='assets/images/8_de_junio.webp' fluid /> },
    { src: 'assets/images/4_de_junio.webp', alt: 'imagen-2', clickable: false, type: 'image', component: <Image src='assets/images/4_de_junio.webp' fluid /> },
