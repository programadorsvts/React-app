...
function footer() {
  return (
    ...
    <Container fluid className="footer">
            <div className="text-left mt-5" xs={12} md={4}>
                <h6 className="text-1">Información Institucional</h6>
                <img src="../../image/Escudo-UNSL-Blanco.svg" width="150" height="100" alt=""/>  
                <p className='text-4'>Dirección:<a className="text-secondary" href="https://www.google.com/maps/place/Universidad+Nacional+de+San+Luis/@-33.2920509,-66.341365,17.6z/data=!4m9!1m2!2m1!1sunsl!3m5!1s0x95d4394eec782487:0x2bcfdfba83514ad4!8m2!3d-33.2921332!4d-66.3396195!15sCgR1bnNsWgYiBHVuc2ySAQp1bml2ZXJzaXR5mgEkQ2hkRFNVaE5NRzluUzBWSlEwRm5TVVJWT1daNk5ucFJSUkFC4AEA" target="_blank" rel="noopener noreferrer">Ejército de los Andes 950 San Luis, Argentina</a></p>
                <p className='text-4'>Telefono: +54 (0266) 4520300</p>
            </div>
            <div className="text-left mt-5"xs={12} md={4}>
                <h6 className="text-1">Contacto</h6>
                <img src="../../image/Logo-Svts-blanco.svg" width="200" height="100" alt=""/>  
